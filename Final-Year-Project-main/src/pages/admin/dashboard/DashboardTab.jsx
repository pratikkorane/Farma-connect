...
import DynamicAveragePricePage from '../../DynamicAveragePricePage';

import { toast } from 'react-toastify';
import { collection, getDocs, query, where } from 'firebase/firestore';
import { fireDB } from '../../../fireabase/FirebaseConfig';
import {  addDoc } from 'firebase/firestore';
import GrapesPriceCreater from '../page/GrapesPriceCreater';
function DashboardTab() {
    ...
    const saveOrderToDatabase =async (order) => {
        try {
            ...
            await addDoc(collection(fireDB, "BestDeals"), order);
    ...
    return (
        <>
            ...
            <div className=' w-2/5 text-center'>
                <h1 className=' font-bold  text-xl mb-2'>Set Market Prices</h1>
                <GrapesPriceCreater /> 
            </div>
        </div>
                    <Tabs defaultIndex={0} className=" " >
                        ...
                        <TabPanel>
                            <div className='  px-4 md:px-0 mb-16'>
                                <h1 className=' text-center mb-5 text-3xl font-semibold underline' style={{ color: mode === 'white' ? 'dark' : '' }}>Product Details</h1>
                                ...
                                <h1 className=' text-center mb-5 text-3xl font-semibold underline' style={{ color: mode === 'dark' ? 'white' : '' }}>Order Details</h1>
                                     ...
                                     <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400" >
                                        ...
                                        {addressArray.map((order) => {
                                            ...
                                            const {finalPrice,imageURL, productID,userName } = order;
                                            return (
                                                <tbody>
                                                    <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                        <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                        ...
                                                        <td className="px-6 py-4 text-black" style={{ color: mode === 'dark' ? 'white' : '', width: '150px' }}>
    <img className='w-24 h-24' src={imageURL} alt="img" />
</td>
                                                        ...
                                                        <td>
                                                        {/* Best deal button */}
                                                        <button className='bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded ml-3' onClick={() => saveOrderToDatabase(order)}>Best Deal</button>
                                                    </td>
                        ...
                        <TabPanel>
                            ...
                            <div className="relative overflow-x-auto mb-10">
                                ...
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    ...
                                    {user.map((item, index) => {
                                        const { name, uid, email, date,role } = item;
                                        return (
                                            <tbody>
                                                <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                    <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
